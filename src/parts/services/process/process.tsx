...
export const Process = () => {
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.line} data-fade="in" />
      ...
      <div className={s.items}>
        <MyImage data-fade="in" src={`/img/icons/services/${imgPath}diamond-bg-1.svg`} alt="" width={500} height={648} imgClass={s.bg} />

        <div className={s.item}>
          <div className={s.text} data-fade="in">
          ...
          <div className={s.list} data-fade data-child data-x="30px">
        ...
        <div className={s.line_vert} data-fade="in"></div>
      ...
      <div className={s.items}>
        <MyImage data-fade="in" src={`/img/icons/services/${imgPath}diamond-bg-2.svg`} alt="" width={500} height={648} imgClass={s.bg} />
