      ...
      <div className={css.map} data-fade>
        ...
        >
          <SwiperSlide className={css.icon}>
            <MyImage src={`/img/wireframes-map.svg`} alt="User Flow & Wireframes" width={1142} height={392} />
          </SwiperSlide>
        </Swiper>
